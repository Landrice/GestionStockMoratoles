...
import controlleurGui.app.vente.ViewCustomerController;
import controlleurGui.app.vente.ViewSellController;
...
public class SellController implements Initializable {
   ...
   userNameMedia nameMedia;
    ...
    public void tbtnSellOnAction(ActionEvent event) throws IOException {
        lblPathInfo.setText("Achats");
        ViewSellController sellController = new ViewSellController();
        userNameMedia media = new userNameMedia();
        FXMLLoader fXMLLoader = new FXMLLoader();
        fXMLLoader.load(getClass().getResource("/gui/app/vente/ViewSell.fxml").openStream());
        media.setId(userId);
